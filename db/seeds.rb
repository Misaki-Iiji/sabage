...
# ユーザー作成
user1 = User.create({nickname:"宮田くん", email: "user1@user.com", password: "111111", introduction: "よろしく", main_gun: "M700"})
user2 = User.create({nickname:"アスカ", email: "user2@user.com", password: "111111", introduction: "ようかん好きです", main_gun: "P90"})
user3 = User.create({nickname:"キョン", email: "user3@user.com", password: "111111", introduction: "よろしく", main_gun: "MK18"})
user4 = User.create({nickname:"ネギ", email: "user4@user.com", password: "111111", introduction: "よろしくお願いします！", main_gun: "M1851"})
user5 = User.create({nickname:"キキ", email: "user5@user.com", password: "111111", introduction: "森林メインです", main_gun: "特になし"})
user6 = User.create({nickname:"ダンペイ", email: "user6@user.com", password: "111111", introduction: "ワシのジョー", main_gun: "mp5"})
user7 = User.create({nickname:"ねずこ", email: "user7@user.com", password: "111111", introduction: "", main_gun: "HK416D"})
user8 = User.create({nickname:"矢吹くん", email: "user8@user.com", password: "111111", introduction: "", main_gun: "なし"})
user9 = User.create({nickname:"五代くん", email: "user9@user.com", password: "111111", introduction: "", main_gun: "G3 SAS HC"})
...
chat_group5 = ChatGroup.create({chat_group_name:"チームメンバー募集です", chat_group_description:"目標20人！！活動拠点は埼玉がメインです。年齢職業問いません！！"})
